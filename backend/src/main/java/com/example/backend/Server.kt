                ...
                try {
                    ...
                    if (activeRoom != null) {
                        ...
                        if (activeRoom.sessions.isEmpty()) {
                            ...
                            if (playerId == activeRoom.roomData.hostId) {
                                println("Host left. Closing room $incomingRoomId for everyone.")
                                closeRoom(incomingRoomId)
                            } else {
